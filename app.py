...
# --- Game Constants ---
ALL_PERKS = [
    "Genius Intellect", "Artistic Talent", "Athletic Prowess", "Charismatic Leader", 
    "Financial Mogul", "Kind Heart", "Resilient Body", "Lucky Charm", "Inventive Mind",
    "Musical Prodigy", "Master Negotiator", "Photographic Memory"
]
